...
This is a minor feature that displays information for the user on the console about password security, such as avoiding using the same password twice, avoiding character repetition, keyboard patterns, dictionary words, lettissue showing an image, added in the Markdown, of an Octocat smiling and raising a tentacle.er or number sequences, etc.
